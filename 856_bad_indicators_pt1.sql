...
(
     ( v.marc_ind1 = '0' and replace(v.field_content, 'http://libproxy.lib.unc.edu/login?url=', '') !~* '\|u *mailto') or
     ( v.marc_ind1 = '1' and replace(v.field_content, 'http://libproxy.lib.unc.edu/login?url=', '') !~* '\|u *ftp') or
     ( v.marc_ind1 = '2' and replace(v.field_content, 'http://libproxy.lib.unc.edu/login?url=', '') !~* '\|u *telnet') or
